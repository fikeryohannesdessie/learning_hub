...
class _ForgotPasswordScreenState extends ConsumerState<ForgotPasswordScreen> {
  ...
  Future<void> _verifySecurityAnswers() async {
    if (_securityFormKey.currentState!.validate()) {
      ...
      final isVerified = await ref
          ...
          .verifySecurityAnswers(_emailController.text.trim(), [
    ...
    if (_passwordFormKey.currentState!.validate()) {
      ...
      if (!authState.hasError) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: TranslatedText(
              'Failed to reset password: ${authState.error}',
            ),
  ...
  Widget _buildCurrentStep(String lang) {
    switch (_currentStep) {
      case 1:
        return _buildStep1Email(lang);
      case 2:
        return _buildStep2Security(lang);
      case 3:
        return _buildStep3NewPassword(lang);
      default:
                ...
                children: [
                  ...
                  Expanded(
                    child: TranslatedText(
                      getTranslatedSync(_errorMsg!, lang),
